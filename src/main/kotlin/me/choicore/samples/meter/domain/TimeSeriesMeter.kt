...
class TimeSeriesMeter(
    private val meteringStrategyResolver: MeteringStrategySelector,
) : Meter {
    override fun measure(measurand: Measurand): List<Metric> = meteringStrategyResolver.select(measurand).measure(measurand)
